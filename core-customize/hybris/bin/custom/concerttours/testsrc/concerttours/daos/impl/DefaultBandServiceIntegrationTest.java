...
public class DefaultBandServiceIntegrationTest extends ServicelayerTest
{
    ...
    private static final String BAND_HISTORY = "New contemporary, 7-piece Jazz unit from London, formed in 2015";
    ...
    /**
     * This test tests and demonstrates that the Service's getAllBand method calls the DAOs' findBands method and
     * returns the data it receives from it.
     */
    @Test
