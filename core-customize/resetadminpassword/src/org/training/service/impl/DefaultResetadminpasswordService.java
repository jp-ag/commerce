...
public class DefaultResetadminpasswordService implements ResetadminpasswordService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultResetadminpasswordService.class);
	...
	{
		return DefaultResetadminpasswordService.class.getResourceAsStream("/resetadminpassword/sap-hybris-platform.png");
	}
